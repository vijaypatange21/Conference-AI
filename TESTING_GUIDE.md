...
curl http://localhost:8000/api/interactions/top_combinations/?event_id=1&limit=10
```
...
curl "http://localhost:8000/api/interactions/my_connections/?attendee_id=1&event_id=1"
```
